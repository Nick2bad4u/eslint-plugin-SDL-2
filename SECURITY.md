...
- GitHub Security Advisory draft: <https://github.com/Nick2bad4u/eslint-plugin-sdl-2/security/advisories/new>
...
- Keep `eslint-plugin-sdl-2`, ESLint, TypeScript, and dependencies updated.
